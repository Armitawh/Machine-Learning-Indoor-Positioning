...
lambda = 1; 
ridgeModel = fitrlinear(XTrain, YTrain, 'Learner', 'leastsquares', 'Regularization', 'ridge', 'Lambda', lambda);

YPred = predict(ridgeModel, XTest);
...
saveas(gcf, fullfile(getenv('USERPROFILE'), 'Desktop', 'PredictedVsActualRidge.png'));
...
saveas(gcf, fullfile(getenv('USERPROFILE'), 'Desktop', 'ErrorHistogramRidge.png'));
